...
- Purely decorative HTML elements get `aria-hidden="true"` and are not focusable; meaningful non-text illustrations or effects need an accessible name, caption, or nearby text (surface-details)
...
- [ ] `aria-hidden` on decorative icons and decorative DOM
- [ ] Meaningful non-text illustrations or effects have an accessible name, caption, or nearby text
